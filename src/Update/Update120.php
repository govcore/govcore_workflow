...
/**
 * Contains optional updates targeting GovCore Workflow 1.2.0.
 *
 * @Update("1.2.0")
 */
final class Update120 implements ContainerInjectionInterface, ContainerAwareInterface {
  ...
  public function grantUnpublishedContentReviewerAccess(StyleInterface $io) {
    if (!$this->moduleHandler->moduleExists('govcore_roles')) {
      return;
    }

    /** @var \Drupal\govcore_roles\ContentRoleManager $role_manager */
    $role_manager = $this->container->get('govcore.content_roles');
