...
namespace Drupal\govcore_workflow\Update;
...
use Drupal\govcore_roles\ContentRoleManager;
use Symfony\Component\Console\Style\StyleInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Contains optional updates targeting GovCore Workflow 2.3.0.
 *
 * @Update("2.3.0")
 */
final class Update230 implements ContainerInjectionInterface {
   ...
   *
   * @var \Drupal\govcore_roles\ContentRoleManager
   */
   ...
   * @param \Drupal\govcore_roles\ContentRoleManager $content_role_manager
  ...
  public static function create(ContainerInterface $container) {
    ...
    if ($container->get('module_handler')->moduleExists('govcore_roles')) {
      $content_role_manager = $container->get('govcore.content_roles');
    }
