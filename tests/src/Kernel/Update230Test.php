...
use Drupal\govcore_workflow\Update\Update230;
 ...
 *
 * @coversDefaultClass \Drupal\govcore_workflow\Update\Update230
 */
class Update230Test extends KernelTestBase {
   ...
   *
   * @var \Drupal\govcore_workflow\Update\Update230
   */
  private $update;
  ...
  public function testEnableModerationSidebar() {
    $this->container->get('module_installer')->install(['govcore_roles']);
